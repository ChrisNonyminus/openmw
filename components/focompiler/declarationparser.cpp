...
FOCompiler::DeclarationParser::DeclarationParser (Compiler::ErrorHandler& errorHandler,
...
bool FOCompiler::DeclarationParser::parseInt (int value, const Compiler::TokenLoc& loc, Scanner& scanner)
{
...
bool FOCompiler::DeclarationParser::parseName (const std::string& name, const Compiler::TokenLoc& loc,
    Scanner& scanner)
{
    if (mState==NameState)
    {
...
bool FOCompiler::DeclarationParser::parseKeyword (int keyword, const Compiler::TokenLoc& loc, Scanner& scanner)
{
...
bool FOCompiler::DeclarationParser::parseSpecial (int code, const Compiler::TokenLoc& loc, Scanner& scanner)
{
...
void FOCompiler::DeclarationParser::parseEOF(Scanner& scanner)
{
    // ignore
}

void FOCompiler::DeclarationParser::reset()
{
    mState = StartState;
}
