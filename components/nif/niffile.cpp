...
static std::map<std::string, CreateRecord> makeFactory()
{
    return 
    {
        ...
        {"NiBSBoneLODController"            , &construct <NiBSBoneLODController             , RC_NiBSBoneLODController              >},
        ...
        {"NiBSplineInterpolator"            , &construct <NiBSplineInterpolator             , RC_NiBSplineInterpolator              >},
