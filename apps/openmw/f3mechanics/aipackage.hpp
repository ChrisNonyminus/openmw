#ifndef GAME_F3MECHANICS_AIPACKAGE_H
#define GAME_F3MECHANICS_AIPACKAGE_H
...
{
    // todo: abstract mwmechanics's aipackage, then make that and this inherit/implement the resulting abstract class
    class AiPackage
    {
        public:
            struct Options
            ...
            AiPackage(AiPackageTypeId typeId, const Options& options, std::string name = "");
            ...
            virtual void writeState (std::vector<ESM4::AIPackage>& sequence) const {}
        ...
        protected:
            ...
            const ESM4::NavMesh *getNavMesh(const MWWorld::CellStore* cell);
