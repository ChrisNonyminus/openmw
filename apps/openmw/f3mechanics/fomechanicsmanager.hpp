#ifndef F3MECHANICS_MECHANICSMANAGERIMP_H
#define F3MECHANICS_MECHANICSMANAGERIMP_H
...
namespace F3Mechanics
{
    ...
    public:
        ...
        {
            // birthsigns not in fallout
        }

        void setPlayerClass(const std::string& id) override; // fallout has no "classes" per-se, but still uses the CLAS record to handle character stats.
