...
namespace MWClass
{
    ...
    // todo: commented out function decls need to be implemented
    // and also maybe move esm4creature into a "obclass" folder
    class ESM4Creature : public MWWorld::RegisteredClass<ESM4Creature, Actor>
    {
        ...
        /*struct GMST
        {
            const ESM4::GameSetting* fMinWalkSpeedCreature;
            const ESM4::GameSetting* fMaxWalkSpeedCreature;
            const ESM4::GameSetting* fEncumberedMoveEffect;
            const ESM4::GameSetting* fSneakSpeedMultiplier;
            const ESM4::GameSetting* fAthleticsRunBonus;
            const ESM4::GameSetting* fBaseRunMultiplier;
            const ESM4::GameSetting* fMinFlySpeed;
            const ESM4::GameSetting* fMaxFlySpeed;
            const ESM4::GameSetting* fSwimRunBase;
            const ESM4::GameSetting* fSwimRunAthleticsMult;
            const ESM4::GameSetting* fKnockDownMult;
            const ESM4::GameSetting* iKnockDownOddsMult;
            const ESM4::GameSetting* iKnockDownOddsBase;
        };*/
    ...
    public:
        ...
        F3Mechanics::Stats& getFOStats(const MWWorld::Ptr& ptr) const override;
