...
namespace MWClass
{
    ...
    class Tes4Npc : public MWWorld::RegisteredClass<Tes4Npc, Actor>
    {
        friend MWWorld::RegisteredClass<Tes4Npc, Actor>;
    ...
    public:
        ...
        void setFaceGenEmotion(const MWWorld::Ptr& ptr, std::map<std::string, float> fgPoses);
    };
}
